    ...
    <script>
        ...
        function checkPasswordStrength() {
            const pass = document.getElementById('<%= txtNewPass.ClientID %>').value;
                ...
                if (pass === '') {
                    bar.style.width = '0%';
                    bar.style.backgroundColor = '#e4e6eb'; // màu xám nhạt
                    text.textContent = 'Độ mạnh của mật khẩu';
                    text.style.color = '#606770'; // màu xám
                ...
                requirements.forEach(req => {
                    ...
                    if (req.test) {
                        ...
                        icon.src = '../Assets/images/icon/circle-outline-green.svg'; // icon xanh
                        strength++;
                    } else {
                        el.classList.remove('valid');
                        icon.src = '../Assets/images/icon/circle-outline.svg'; // icon xám
                    }
                });
