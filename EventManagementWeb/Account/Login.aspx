        ...
        <div class="login-box">
            ...
            <div class="form-group">
                ...
                <div class="input-password">
                    ...
                    <img id="toggleIcon" src="../Assets/images/icon/eye-close.svg" alt="Toggle Password Visibility" class="toggle-password" onclick="togglePasswordVisibility()" />
                </div>
            </div>
            ...
            <div class="cta">
                <a href="ForgotPassword.aspx" class='cta-link'>
                    Quên mật khẩu?
                </a>
            </div>
