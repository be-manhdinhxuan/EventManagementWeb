<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreateNewUser.aspx.cs" Inherits="EventManagementWeb.Admin.CreateNewUser" %>
...
<head runat="server">
    ...
    <link href="../Assets/css/pages/create-new-user.css" rel="stylesheet" />
</head>
<body>
    <form id="form1" runat="server">
        <div class="parent">
            ...
            <!-- Main -->
            <main class="main">
                <a href="UserManagement.aspx" class="btn--back btn--back__mobile">
                ...
                <div class="form" id="userForm">
                    <div class="form__section">
                        <label class="form__label-input">Họ và tên <span class="required">*</span></label>
                        <input type="text" name="txtFullName" class="form__input" placeholder="Nhập họ và tên" value="<%= FullName %>" <%= IsViewMode ? "readonly" : "required" %> />
                        <label class="form__label-input">Email <span class="required">*</span></label>
                        <input type="email" name="txtEmail" class="form__input" placeholder="Nhập địa chỉ email" value="<%= Email %>" <%= IsViewMode ? "readonly" : "required" %> />

                        <label class="form__label-input">Số điện thoại</label>
                        <input type="tel" name="txtPhone" class="form__input" placeholder="Nhập số điện thoại" value="<%= Phone %>" <%= IsViewMode ? "" : "" %> readonly />

                        <div class="form__row-item">
                            <label class="form__label-input">Phân quyền <span class="required">*</span></label>
                            <select name="ddlRole" class="form__select" <%= IsViewMode ? "disabled" : "" %>>
                        ...
                        <div class="form__input-checkbox">
                            <input type="checkbox" id="sendToEmail" name="chkSendEmail" <%= SendEmail ? "checked" : "" %> />
                            <label for="sendToEmail">Gửi thông báo tới email của người dùng (bao gồm mật khẩu tạm thời)</label>
                        </div>
                        <label class="form__section-note">Mật khẩu tạm thời sẽ được tạo tự động và gửi qua email (nếu chọn).</label>
                        <% } %>
                    </div>
                </div>

                <div class="form__actions">
                    <a href="UserManagement.aspx" class="btn--back">
                        <svg class="btn--back__icon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M5.25 11.25H20.25C20.4489 11.25 20.6397 11.329 20.7803 11.4697C20.921 11.6103 21 11.8011 21 12C21 12.1989 20.921 12.3897 20.7803 12.5303C20.6397 12.671 20.4489 12.75 20.25 12.75H5.25C5.05109 12.75 4.86032 12.671 4.71967 12.5303C4.57902 12.3897 4.5 12.1989 4.5 12C4.5 11.8011 4.57902 11.6103 4.71967 11.4697C4.86032 11.329 5.05109 11.25 5.25 11.25Z" fill="currentColor"></path>
                            <path d="M5.56086 12L11.7814 18.219C11.9222 18.3598 12.0013 18.5508 12.0013 18.75C12.0013 18.9491 11.9222 19.1401 11.7814 19.281C11.6405 19.4218 11.4495 19.5009 11.2504 19.5009C11.0512 19.5009 10.8602 19.4218 10.7194 19.281L3.96936 12.531C3.89952 12.4613 3.84411 12.3785 3.8063 12.2874C3.76849 12.1963 3.74902 12.0986 3.74902 12C3.74902 11.9013 3.76849 11.8036 3.8063 11.7125C3.84411 11.6214 3.89952 11.5386 3.96936 11.469L10.7194 4.71897C10.8602 4.57814 11.0512 4.49902 11.2504 4.49902C11.4495 4.49902 11.6405 4.57814 11.7814 4.71897C11.9222 4.8598 12.0013 5.05081 12.0013 5.24997C12.0013 5.44913 11.9222 5.64014 11.7814 5.78097L5.56086 12Z" fill="currentColor"></path>
                        </svg>
                    ...
                    <div class="forn__actions-gr">
                        <% if (!IsViewMode)
                        { %>
                        <button type="button" class="btn form__button--secondary" onclick="history.back()">Hủy bỏ</button>
                        <button type="submit" name="btnAction" value="create" class="btn form__button--primary">Xác nhận</button>
                        <% }
                        else
                        { %>
        ...
        <!-- Modal Success Account -->
        <div
            class="modal-success-account"
            id="modalSuccessAccount"
            style="display: none;"
            role="dialog"
            aria-labelledby="successAccountTitle"
            aria-describedby="successAccountDesc"
            aria-modal="true"
            onclick="closeSuccessAccountModalOnOverlay(event)">
            <div class="modal-success-account__content">
                <div class="modal-success-account__icon-wrapper">
                    <svg
                        width="36"
                        height="36"
                        viewBox="0 0 36 36"
                ...
                <h2 class="modal-success-account__title" id="successAccountTitle">Tạo tài khoản thành công!
                </h2>

                <div class="modal-success-account__form-group">
                    <label class="modal-success-account__label">
                        Mật khẩu tạm thời
                    </label>
                    <div class="modal-success-account__password-field">
                        <span
                            class="modal-success-account__password-text"
                            id="tempPasswordText">X y 7 ! z P q 9 $ b K 2</span>
                        <button
                            class="modal-success-account__copy-button"
                ...
                <div class="modal-success-account__notification">
                    <svg
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
                        ...
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M1 21L12 2L23 21H1ZM12 18C12.2833 18 12.521 17.904 12.713 17.712C12.905 17.52 13.0007 17.2827 13 17C12.9993 16.7173 12.9033 16.48 12.712 16.288C12.5207 16.096 12.2833 16 12 16C11.7167 16 11.4793 16.096 11.288 16.288C11.0967 16.48 11.0007 16.7173 11 17C10.9993 17.2827 11.0953 17.5203 11.288 17.713C11.4807 17.9057 11.718 18.0013 12 18ZM11 15H13V10H11V15Z"
                            fill="#CA8A04" />
                    </svg>
                    <p class="modal-success-account__description" id="successAccountDesc">
                        Vui lòng lưu mật khẩu hoặc gửi nó cho nhân viên. mật khẩu này sẽ
            không được hiển thị lại.
                ...
                <button
                    type="button"
                    class="modal-success-account__btn modal-success-account__btn--confirm"
                    onclick="confirmSuccessAccount()"
                    aria-label="Đóng">
                    Đóng
                </button>
            </div>
    ...
    <script type="text/javascript">
        function copyTempPassword() {
            const passwordText =
                document.getElementById("tempPasswordText").textContent;
            navigator.clipboard
                .writeText(passwordText.replace(/\s/g, ""))
                .then(() => {
                    alert("Đã sao chép mật khẩu!");
                });
        }

        function confirmSuccessAccount() {
            window.location.href = "#";
        }

        function closeSuccessAccountModalOnOverlay(event) {
            if (event.target.id === "modalSuccessAccount") {
                window.location.href = "#";
            }
        }
    </script>
