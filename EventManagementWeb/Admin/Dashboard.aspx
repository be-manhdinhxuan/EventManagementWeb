...
<head runat="server">
    ...
    <meta name="description" content="EventAdmin - Nền tảng quản lý sự kiện hàng đầu Việt Nam">
    <meta name="keywords" content="quản lý sự kiện, event management, đăng ký sự kiện">
    <meta name="author" content="EventAdmin">
        ...
        <div class="parent">
            ...
            <aside class="sidebar">
                <ul class="sidebar__nav">
                    <li class="sidebar__item">
                        <a href="Dashboard.aspx" class="sidebar__link sidebar__link--active">
                ...
                <section class="stats" aria-label="Thống kê tổng quan">
                    <article class="stats__card">
                        <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M21.75 27C20.7 27 19.8125 26.6375 19.0875 25.9125C18.3625 25.1875 18 24.3 18 23.25C18 22.2 18.3625 21.3125 19.0875 20.5875C19.8125 19.8625 20.7 19.5 21.75 19.5C22.8 19.5 23.6875 19.8625 24.4125 20.5875C25.1375 21.3125 25.5 22.2 25.5 23.25C25.5 24.3 25.1375 25.1875 24.4125 25.9125C23.6875 26.6375 22.8 27 21.75 27ZM7.5 33C6.675 33 5.969 32.7065 5.382 32.1195C4.795 31.5325 4.501 30.826 4.5 30V9C4.5 8.175 4.794 7.469 5.382 6.882C5.97 6.295 6.676 6.001 7.5 6H9V3H12V6H24V3H27V6H28.5C29.325 6 30.0315 6.294 30.6195 6.882C31.2075 7.47 31.501 8.176 31.5 9V30C31.5 30.825 31.2065 31.5315 30.6195 32.1195C30.0325 32.7075 29.326 33.001 28.5 33H7.5ZM7.5 30H28.5V15H7.5V30ZM7.5 12H28.5V9H7.5V12Z" fill="currentColor" />
                        </svg>
                        <p class="stats__label">Tổng số sự kiện</p>
                        <p class="stats__value"><%= TotalEvents %></p>
                    </article>

                    <article class="stats__card">
                        <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M20.25 12H18V19.5L24.42 23.31L25.5 21.495L20.25 18.375V12ZM19.5 4.5C15.9196 4.5 12.4858 5.92232 9.95406 8.45406C7.42232 10.9858 6 14.4196 6 18H1.5L7.44 24.045L13.5 18H9C9 15.2152 10.1062 12.5445 12.0754 10.5754C14.0445 8.60625 16.7152 7.5 19.5 7.5C22.2848 7.5 24.9555 8.60625 26.9246 10.5754C28.8938 12.5445 30 15.2152 30 18C30 20.7848 28.8938 23.4555 26.9246 25.4246C24.9555 27.3938 22.2848 28.5 19.5 28.5C16.605 28.5 13.98 27.315 12.09 25.41L9.96 27.54C11.2074 28.8007 12.6935 29.8001 14.3315 30.48C15.9695 31.16 17.7265 31.5067 19.5 31.5C23.0804 31.5 26.5142 30.0777 29.0459 27.5459C31.5777 25.0142 33 21.5804 33 18C33 14.4196 31.5777 10.9858 29.0459 8.45406C26.5142 5.92232 23.0804 4.5 19.5 4.5Z" fill="currentColor" />
                        </svg>
                        <p class="stats__label">Sự kiện sắp tới</p>
                        <p class="stats__value"><%= UpcomingEvents %></p>
                    </article>

                    <article class="stats__card">
                        <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M15
18.0315 32.1195 18.6195C31.5325 19.2075 30.826 19.501 30 19.5ZM0 27V24.6375C0 23.5375 0.5565 22.656 1.6695 21.993C2.7825 21.33 4.226 20.999 6 21C6.325 21 6.6375 21.0065 6.9375 21.0195C7.2375 21.0325 7.525 21.0635 7.8 21.1125C7.45 21.6125 7.1875 22.15 7.0125 22.725C6.8375 23.3 6.75 23.9125 6.75 24.5625V27H0ZM9 27V24.5625C9 22.9375 9.8315 21.625 11.4945 20.625C13.1575 19.625 15.326 19.125 18 19.125C20.7 19.125 22.875 19.625 24.525 20.625C26.175 21.625 27 22.9375 27 24.5625V27H9ZM30 21C31.8 21 33.25 21.3315 34.35 21.9945C35.45 22.6575 36 23.5385 36 24.6375V27H29.25V24.5625C29.25 23.9125 29.169 23.3 29.007 22.725C28.845 22.15 28.601 21.6125 28.275 21.1125C28.55 21.0625 28.8315 21.0315 29.1195 21.0195C29.4075 21.0075 29.701 21.001 30 21ZM18 22.125C16.575 22.125 15.3 22.3125 14.175 22.6875C13.05 23.0625 12.3875 23.5 12.1875 24H23.85C23.625 23.5 22.956 23.0625 21.843 22.6875C20.73 22.3125 19.449 22.125 18 22.125Z" fill="currentColor" />
                        </svg>
                        <p class="stats__label">Tổng số nhân viên</p>
                        <p class="stats__value"><%= TotalEmployees %></p>
                    </article>

                    <article class="stats__card">
                        <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_196_3507)">
                                <path d="M28.5 25.5V28.5H10.5V25.5C10.5 25.5 10.5 19.5 19.5 19.5C28.5 19.5 28.5 25.5 28.5 25.5ZM24 12C24 11.11 23.7361 10.24 23.2416 9.49994C22.7471 8.75991 22.0443 8.18314 21.2221 7.84254C20.3998 7.50195 19.495 7.41283 18.6221 7.58647C17.7492 7.7601 16.9474 8.18868 16.318 8.81802C15.6887 9.44736 15.2601 10.2492 15.0865 11.1221C14.9128 11.995 15.0019 12.8998 15.3425 13.7221C15.6831 14.5443 16.2599 15.2471 16.9999 15.7416C17.74 16.2361 18.61 16.5 19.5 16.5C20.6935 16.5 21.8381 16.0259 22.682 15.182C23.5259 14.3381 24 13.1935 24 12ZM28.8 19.59C29.6199 20.3465 30.281 21.2587 30.7446 22.2734C31.2081 23.2881 31.465 24.385 31.5 25.5V28.5H36V25.5C36 25.5 36 20.325 28.8 19.59ZM27 7.5C26.5468 7.50003 26.0963 7.57088 25.665 7.71C26.5426 8.96846 27.0131 10.4658 27.0131 12C27.0131 13.5342 26.5426 15.0315 25.665 16.29C26.0963 16.4291 26.5468 16.5 27 16.5C28.1935 16.5 29.3381 16.0259 30.182 15.182C31.0259 14.3381 31.5 13.1935 31.5 12C31.5 10.8065 31.0259 9.66194 30.182 8.81802C29.3381 7.97411 28.1935 7.5 27 7.5ZM11.01 13.38L12.75 15.495L5.625 22.62L1.5 18.12L3.24 16.38L5.625 18.75L11.01 13.38Z" fill="currentColor" />
                            </g>
                            <defs>
                                <clipPath id="clip0_196_3507">
                                    <rect width="36" height="36" fill="white" />
                                </clipPath>
                            </defs>
                        </svg>
                        <p class="stats__label">Tổng số đăng ký</p>
                        <p class="stats__value"><%= TotalRegistrations %></p>
                    </article>
                </section>
                ...
                <div class="content">
                    <section class="section" aria-labelledby="events-title">
                        <div class="section__header">
                            <h2 class="section__title" id="events-title">Sự kiện gần đây</h2>
                        </div>

                        <div class="events__header" role="row">
                            <div class="events__header-cell" role="columnheader">Tiêu đề</div>
                            <div class="events__header-cell" role="columnheader">Ngày</div>
                            <div class="events__header-cell" role="columnheader">Trạng thái</div>
                            <div class="events__header-cell" role="columnheader">Số lượng đăng ký</div>
                        </div>

                        <div class="events__body">
                            <% if (RecentEvents.Rows.Count == 0)
                                { %>
                            <div class="events__row events__row--empty">
                            ...
                            <div class="events__row" role="row">
                                <div class="events__name" role="cell">
                                    <a href="EventManagement.aspx?edit=<%= row["Id"] %>"><%= row["Title"] %></a>
                                </div>
                                <div class="events__date" role="cell">
                                    <%= Convert.ToDateTime(row["StartTime"]).ToString("dd-MM-yyyy") %>
                                </div>
                                <div role="cell">
                                    <span class="events__status <%= GetEventStatusClass(row["Status"].ToString()) %>">
                                        <%= GetEventStatusText(row["Status"].ToString()) %>
                                    </span>
                                </div>
                                <div class="events__count" role="cell"><%= row["CurrentRegistrations"] %></div>
                            </div>
                            <% } %>
                            <% } %>
                        </div>
                    ...
                    <section class="section" aria-labelledby="registrations-title">
                        <div class="section__header">
                            <h2 class="section__title" id="registrations-title">Đăng ký gần đây</h2>
                        </div>

                        <div class="registrations">
                            <% if (RecentRegistrations.Rows.Count == 0)
                                { %>
                            <p class="registrations__empty">Chưa có đăng ký nào.</p>
                            <% }
                            else
                            { %>
                            <% foreach (DataRow row in RecentRegistrations.Rows)
                                { %>
                            <article class="registrations__item">
                                <% 
                                    string avatarPath = row["UserAvatar"]?.ToString();
                                    string avatarUrl = string.IsNullOrEmpty(avatarPath)
                                        ? "../Assets/images/avatar.jpg"
                                        : "../Uploads/avatars/" + avatarPath;
                                %>
                                <img src="<%= avatarUrl %>" alt="<%= row["FullName"] %> avatar" class="registrations__avatar">
                                <div class="registrations__info">
                                    <p class="registrations__name"><%= row["FullName"] %></p>
                                    <p class="registrations__event"><%= row["EventTitle"] %></p>
                                </div>
                                <div class="registrations__time"><%= GetRelativeTime(Convert.ToDateTime(row["RegistrationTime"])) %></div>
                            </article>
                            <% } %>
                            <% } %>
                        </div>
            ...
            <nav class="nav">
                <ul class="nav__mobile">
                    <li class="nav__item">
                        <a href="Dashboard.aspx" class="nav__link nav__link--active">
