            ...
            <main class="main">
                ...
                <nav class="events-tabs" role="tablist" aria-label="Bộ lọc sự kiện">
                    <ul class="events-tabs__list">
                        ...
                        <!-- UPCOMING -->
                        <li class="events-tabs__item <%= CurrentTab == "upcoming" ? "events-tabs__item--active" : "" %>">
                            <button type="submit" name="tabAction" value="upcoming" class="events-tabs__button">
                                <span>Sắp tới</span>
                            </button>
                            <span class="events-tabs__badge"><%= CountUpcoming %></span>
                        </li>

                        <!-- ATTENDED -->
                        <li class="events-tabs__item <%= CurrentTab == "attended" ? "events-tabs__item--active" : "" %>">
                            <button type="submit" name="tabAction" value="attended" class="events-tabs__button">
                                <span>Đã tham gia</span>
                            </button>
                            <span class="events-tabs__badge"><%= CountAttended %></span>
                        </li>

                        <!-- CANCELLED -->
                        <li class="events-tabs__item <%= CurrentTab == "cancelled" ? "events-tabs__item--active" : "" %>">
                            <button type="submit" name="tabAction" value="cancelled" class="events-tabs__button">
                                <span>Đã hủy</span>
                            </button>
                            <span class="events-tabs__badge"><%= CountCancelled %></span>
                        </li>
                    </ul>
                </nav>
                ...
                <section class="events__grid">
                    ...
                    <div class="no-events">
                        <div class="no-events__content">
                            ...
                            <p class="no-events__desc">Bạn hiện chưa đăng ký tham gia sự kiện nào trong danh mục này.</p>
                        </div>
                    </div>
                    <% } %>
                </section>
