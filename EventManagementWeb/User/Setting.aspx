<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Setting.aspx.cs" Inherits="EventManagementWeb.User.Setting" %>
...
<head runat="server">
    ...
    <link href="../Assets/css/pages/setting-user.css" rel="stylesheet" />
</head>
<body>
        ...
        <div class="parent">
            ...
            <aside class="sidebar">
                <ul class="sidebar__nav">
                    ...
                    <li class="sidebar__item">
                        <a href="Setting.aspx" class="sidebar__link sidebar__link--active">
                            <svg
                                width="32"
                                height="32"
                                viewBox="0 0 32 32"
            ...
            <!-- Main -->
            <main class="main">
                <h1 class="main__title">Cài đặt</h1>

                <!-- Profile Section -->
                <section class="profile">
                    <h2 class="profile__title">Thông tin cá nhân</h2>
                    <section class="profile__block-information">
                        <div class="profile__avatar">
                            <label class="profile__avatar-label">Ảnh đại diện</label>
                            <div class="profile__avatar-wrapper">
                                <div class="profile__avatar-edit">
                                    <img src="<%= UserAvatar %>" alt="Ảnh đại diện của <%= FullName %>" class="profile__avatar-img">
                                </div>
                                <p class="profile__avatar-note">PNG hoặc JPG, tối đa 800x800px</p>
                            </div>
                        </div>
                            ...
                            <form method="post" enctype="multipart/form-data">
                                <div class="profile__form">
                                    <div class="profile__field">
                                        <label for="fullname" class="profile__label">Họ và tên</label>
                                        <input type="text" name="fullname" id="fullname" class="profile__input"
                                            value="<%= FullName %>" required aria-required="true">
                                    </div>
                                    <div class="profile__field">
                                    ...
                                    <div class="profile__field">
                                        <label for="phone" class="profile__label">Số điện thoại</label>
                                        <input type="tel" name="phone" id="phone" class="profile__input"
                                            value="<%= Phone ?? "" %>" placeholder="Nhập số điện thoại của bạn">
                                    </div>
                                    <div class="profile__field">
                                        <label for="avatar" class="profile__label">Thay đổi ảnh đại diện</label>
                                        <input type="file" name="avatar" id="avatar" accept="image/png,image/jpeg" class="profile__input">
                                    </div>
                                    <div class="profile__actions">
                                        <button type="submit" name="btnAction" value="updateProfile" class="btn profile__button">
                                            Lưu thay đổi
                ...
                <section class="password">
                    <h2 class="password__title">Thay đổi mật khẩu</h2>
                    <form method="post" >
                        <div class="password__form">
                            <div class="password__field">
                                <label for="current-password" class="password__label">Mật khẩu hiện tại</label>
                                <div class="password__input-wrapper">
                                    <input type="password" name="currentPassword" id="current-password" class="password__input"
                                        placeholder="Nhập mật khẩu hiện tại" required aria-required="true">
                                    <img id="toggleIconCurrent" src="../Assets/images/icon/eye-close.svg" alt="Toggle" class="toggle-password"
                                        onclick="togglePasswordVisibility('current-password', 'toggleIconCurrent')" />
                                </div>
                            </div>
                            <div class="password__field">
                                <label for="new-password" class="password__label">Mật khẩu mới</label>
                                <div class="password__input-wrapper">
                                    <input type="password" name="newPassword" id="new-password" class="password__input"
                                        placeholder="Nhập mật khẩu mới" required aria-required="true" oninput="checkPasswordStrength()">
                                    <img id="toggleIconNew" src="../Assets/images/icon/eye-close.svg" alt="Toggle" class="toggle-password"
                                        onclick="togglePasswordVisibility('new-password', 'toggleIconNew')" />
                                </div>
                            </div>
                            <div class="password__field">
                                <label for="confirm-password" class="password__label">Xác nhận mật khẩu mới</label>
                                <div class="password__input-wrapper">
                                    <input type="password" name="confirmPassword" id="confirm-password" class="password__input"
                                        placeholder="Nhập lại mật khẩu mới" required aria-required="true">
                                    <img id="toggleIconConfirm" src="../Assets/images/icon/eye-close.svg" alt="Toggle" class="toggle-password"
                                        onclick="togglePasswordVisibility('confirm-password', 'toggleIconConfirm')" />
                                </div>
                            </div>
                            ...
                            <div class="password__actions">
                                <button type="submit" name="btnAction" value="changePassword" class="btn password__button">
                                    Đổi mật khẩu
    ...
    <script type="text/javascript">
        ...
        function checkPasswordStrength() {
            ...
            let percentage, color, textContent;
            if (strength <= 2) {
                percentage = strength * 20;
                color = '#dc3545';
                textContent = strength === 1 ? 'Yếu' : 'Rất yếu';
            } else if (strength <= 3) {
                percentage = 60;
                color = '#ffc107';
                textContent = 'Trung bình';
            } else {
                percentage = strength === 4 ? 80 : 100;
                color = '#28a745';
                textContent = strength === 4 ? 'Mạnh' : 'Rất mạnh';
            }
